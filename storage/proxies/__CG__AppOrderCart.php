 ...
 */
class OrderCart extends \App\OrderCart implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'total_price', 'orderCartProducts', 'user', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderCart $proxy) {
    ...
    public function getOrderCartProducts()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderCartProducts', []);

        return parent::getOrderCartProducts();
    }
     ...
     * {@inheritDoc}
     */
    public function removeProduct(\App\Product $product)
    {
