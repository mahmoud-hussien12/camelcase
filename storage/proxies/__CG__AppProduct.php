 ...
 */
class Product extends \App\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'price', 'image_path', 'cartProducts', 'orderProducts', 'type'];
        }
