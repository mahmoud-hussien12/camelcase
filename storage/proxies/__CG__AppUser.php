...
class User extends \App\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['email' => NULL, 'name' => NULL, 'password' => NULL];
    ...
    {
        unset($this->email, $this->name, $this->password);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'name', 'password', 'fillable', 'hidden'];
        }

        return ['__isInitialized__', 'id', 'fillable', 'hidden'];
    }
